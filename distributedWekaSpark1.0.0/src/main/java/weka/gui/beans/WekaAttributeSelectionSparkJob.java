...
@KFStep(category = "Spark",
  toolTipText = "Find best attributes for Weka classifier")
public class WekaAttributeSelectionSparkJob extends AbstractSparkJob {

  /** For serialization */
  private static final long serialVersionUID = 1090562622978636220L;
  ...
  public WekaAttributeSelectionSparkJob() {
    super();
    m_job = new weka.distributed.spark.WekaAttributeSelectionSparkJob();

    m_visual.setText("WekaAttributeSelectionSparkJob");
  }
  ...
  protected void notifyJobOutputListeners() {
    String evalText =
      ((weka.distributed.spark.WekaAttributeSelectionSparkJob) m_runningJob)
        .getText();
