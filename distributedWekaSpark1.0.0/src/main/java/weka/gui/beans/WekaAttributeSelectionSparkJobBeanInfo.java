 ...
 */
public class WekaAttributeSelectionSparkJobBeanInfo extends
  ...
  public EventSetDescriptor[] getEventSetDescriptors() {
    try {
      ...
      descriptors.add(new EventSetDescriptor(
        WekaAttributeSelectionSparkJob.class, "text", TextListener.class,
        "acceptText"));
      descriptors.add(new EventSetDescriptor(
    		  WekaAttributeSelectionSparkJob.class, "dataSet",
  ...
  public BeanDescriptor getBeanDescriptor() {
    return new BeanDescriptor(
      weka.gui.beans.WekaAttributeSelectionSparkJob.class,
