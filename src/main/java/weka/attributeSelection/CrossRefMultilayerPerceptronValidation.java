 ...
 * @see Discretize
 */
public class CrossRefMultilayerPerceptronValidation extends ASEvaluation implements SubsetEvaluator,
   ...
   * Constructor
   */
  public CrossRefMultilayerPerceptronValidation() {
    resetOptions();
  }
  ...
  public void buildEvaluator(Instances data) throws Exception {
	...
	m_Classifier.setLearningRate(0.2);
...
//    return merit;
  ...
  public static void main(String[] args) {
    runEvaluator(new CrossRefMultilayerPerceptronValidation(), args);
  }
}
